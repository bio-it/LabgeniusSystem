...
MAX_SPEED = 0x07
MAX_SPEED_BITLEN = 10
MAX_SPEED_NAME = 'max_speed'
MAX_SPEED_DEF = 0x041
MIN_SPEED = 0x08
MIN_SPEED_BITLEN = 13
MIN_SPEED_NAME = 'min_speed'
MIN_SPEED_DEF = 0
FS_SPD = 0x15
FS_SPD_BITLEN = 10
FS_SPD_NAME = 'fs_spd'
...
KVAL_HOLD = 0x09
KVAL_HOLD_BITLEN = 8
KVAL_HOLD_NAME = 'kval_hold'
KVAL_HOLD_DEF = 0x29
KVAL_RUN = 0x0A
KVAL_RUN_BITLEN = 8
KVAL_RUN_NAME = 'kval_run'
KVAL_RUN_DEF = 0x29
KVAL_ACC = 0x0B
KVAL_ACC_BITLEN = 8
KVAL_ACC_NAME = 'kval_acc'
KVAL_ACC_DEF = 0x29
KVAL_DEC = 0x0C
KVAL_DEC_BITLEN = 8
KVAL_DEC_NAME = 'kval_dec'
KVAL_DEC_DEF = 0x29
INT_SPD = 0x0D
INT_SPD_BITLEN = 14
INT_SPD_NAME = 'int_spd'
INT_SPD_DEF = 0x0408
ST_SLP = 0x0E
ST_SLP_BITLEN = 8
ST_SLP_NAME = 'st_slp'
...
FN_SLP_ACC = 0x0F
FN_SLP_ACC_BITLEN = 8
FN_SLP_ACC_NAME = 'fn_slp_acc'
FN_SLP_ACC_DEF = 0x29
FN_SLP_DEC = 0x10
FN_SLP_DEC_BITLEN = 8
FN_SLP_DEC_NAME = 'fn_slp_dec'
FN_SLP_DEC_DEF = 0x29
K_THERM = 0x11
K_THERM_BITLEN = 4
K_THERM_NAME = 'k_therm'
K_THERM_DEF = 0
ADC_OUT = 0x12
ADC_OUT_BITLEN = 5
ADC_OUT_NAME = 'adc_out'
ADC_OUT_DEF = 0
OCD_TH = 0x13
OCD_TH_BITLEN = 4
OCD_TH_NAME = 'ocd_th'
...
STALL_TH = 0x14
STALL_TH_BITLEN = 7
STALL_TH_NAME = 'stall_th'
STALL_TH_DEF = 0x40
STEP_MODE = 0x16
STEP_MODE_BITLEN = 8
STEP_MODE_NAME = 'step_mode'
STEP_MODE_DEF = 0x07
ALARM_EN = 0x17
ALARM_EN_BITLEN = 8
ALARM_EN_NAME = 'alram_en'
ALARM_EN_DEF = 0xff
CONFIG = 0x18
CONFIG_BITLEN = 16
CONFIG_NAME = 'config'
...
###################################
_registers = [
    Register(ABS_POS_NAME, ABS_POS, ABS_POS_BITLEN,
             ABS_POS_DEF, ABS_POS_DEF, True),
    Register(EL_POS_NAME, EL_POS, EL_POS_BITLEN,
             EL_POS_DEF, EL_POS_DEF, False),
    ...
    Register(MAX_SPEED_NAME, MAX_SPEED, MAX_SPEED_BITLEN,
             MAX_SPEED_DEF, MAX_SPEED_DEF, True),
    Register(MIN_SPEED_NAME, MIN_SPEED, MIN_SPEED_BITLEN,
             MIN_SPEED_DEF, MIN_SPEED_DEF, True),
    Register(FS_SPD_NAME, FS_SPD, FS_SPD_BITLEN, FS_SPD_DEF, FS_SPD_DEF, True),
    Register(KVAL_HOLD_NAME, KVAL_HOLD, KVAL_HOLD_BITLEN,
             KVAL_HOLD_DEF, KVAL_HOLD_DEF, True),
    Register(KVAL_RUN_NAME, KVAL_RUN, KVAL_RUN_BITLEN,
             KVAL_RUN_DEF, KVAL_RUN_DEF, True),
    Register(KVAL_ACC_NAME, KVAL_ACC, KVAL_ACC_BITLEN,
             KVAL_ACC_DEF, KVAL_ACC_DEF, True),
    Register(KVAL_DEC_NAME, KVAL_DEC, KVAL_DEC_BITLEN,
             KVAL_DEC_DEF, KVAL_DEC_DEF, True),
    Register(INT_SPD_NAME, INT_SPD, INT_SPD_BITLEN,
             INT_SPD_DEF, INT_SPD_DEF, True),
    Register(ST_SLP_NAME, ST_SLP, ST_SLP_BITLEN, ST_SLP_DEF, ST_SLP_DEF, True),
    Register(FN_SLP_ACC_NAME, FN_SLP_ACC, FN_SLP_ACC_BITLEN,
             FN_SLP_ACC_DEF, FN_SLP_ACC_DEF, True),
    Register(FN_SLP_DEC_NAME, FN_SLP_DEC, FN_SLP_DEC_BITLEN,
             FN_SLP_DEC_DEF, FN_SLP_DEC_DEF, True),
    Register(K_THERM_NAME, K_THERM, K_THERM_BITLEN,
             K_THERM_DEF, K_THERM_DEF, True),
    Register(ADC_OUT_NAME, ADC_OUT, ADC_OUT_BITLEN,
             ADC_OUT_DEF, ADC_OUT_DEF, False),
    Register(OCD_TH_NAME, OCD_TH, OCD_TH_BITLEN, OCD_TH_DEF, OCD_TH_DEF, True),
    Register(STALL_TH_NAME, STALL_TH, STALL_TH_BITLEN,
             STALL_TH_DEF, STALL_TH_DEF, True),
    Register(STEP_MODE_NAME, STEP_MODE, STEP_MODE_BITLEN,
             STEP_MODE_DEF, STEP_MODE_DEF, True),
    Register(ALARM_EN_NAME, ALARM_EN, ALARM_EN_BITLEN,
             ALARM_EN_DEF, ALARM_EN_DEF, True),
    Register(CONFIG_NAME, CONFIG, CONFIG_BITLEN, CONFIG_DEF, CONFIG_DEF, True),
    Register(STATUS_NAME, STATUS, STATUS_BITLEN,
             STATUS_DEF, STATUS_DEF, False),
]
# dict map with list comprehension
_registers_map = {r.no: r for r in _registers}
# dict map with list comprehension
...
def bitlen(no):
    ...
    if register == None:
        print(f'l6470.bitlen({no}), no register.')
        return None
...
SET_PARAM = 0x00
SET_PARAM_MASK = 0xe0
SET_PARAM_PARAM_MASK = 0x1f
GET_PARAM = 0x20
GET_PARAM_MASK = 0xe0
GET_PARAM_PARAM_MASK = 0x1f
RUN = 0x50
RUN_MASK = 0xfe
RUN_DIR_MASK = 0x01
STEP_CLOCK = 0x58
STEP_CLOCK_MASK = 0xfe
STEP_CLOCK_DIR_MASK = 0x01
MOVE = 0x40
MOVE_MASK = 0xfe
MOVE_DIR_MASK = 0x01
GOTO = 0x60
...
GOTO_DIR = 0x68
GOTO_DIR_MASK = 0xfe
GOTO_DIR_DIR_MASK = 0x01
GO_UNTIL = 0x82
GO_UNITL_MASK = 0xf2
GO_UNTIL_ACT_MASK = 0x08
GO_UNTIL_DIR_MASK = 0x01
RELEASE_SW = 0x92
RELEASE_SW_MASK = 0xf2
RELEASE_SW_ACT_MASK = 0x08
RELEASE_SW_DIR_MASK = 0x01
GO_HOME = 0x70
GO_HOME_MASK = 0xff
GO_MARK = 0x78
GO_MARK_MASK = 0xff
...
HARD_HIZ_MASK = 0xff
GET_STATUS = 0xD0
GET_STATUS_MASK = 0xff
GET_STATUS_BIT_SIZE = 16
...
# active low, latched and cleared by GetStatus command
STATUS_BIT_STEP_LOSS_A = 0x2000
# active low, latched and cleared by GetStatus command
STATUS_BIT_STEP_LOSS_B = 0x4000
