...
def init_spi(bus, device, mode):
    ...
    # spi.max_speed_hz = 1000000 # ok
    # spi.max_speed_hz = 500000 # ok
    # spi.max_speed_hz = 300000 # ok
...
class AMT203():
    def __init__(self):
        self.timoutLimit = 1000      # this will be our SPI timout limit
    ...
    def read_abs_pos(self):
        ...
        while (self.data != self.rd_pos) and ((self.timeoutCounter) < self.timoutLimit):   # we need to send nop commands while the encoder processes the current position. We
            ...
            # print(f'timeout: {self.timeoutCounter}')
        ...
        # print(f'pos: {self.current_amt20_pos}')
