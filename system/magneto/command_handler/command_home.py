...
_command_list = [
    ...
    # Command(chamber.goto_home, chamber.wait, chamber.stop),
    Command(filter.release_switch, filter.wait, filter.stop),
    Command(filter.search_switch, filter.wait, filter.stop),
    Command(filter.go_to_switch_latch_position, filter.wait, filter.stop),
    Command(filter.set_home_position, filter.wait, filter.stop),
    Command(filter.shift_from_home, filter.wait, filter.stop),
    Command(filter.finish_home, filter.wait, filter.stop),
    # Command(magnet.home, magnet.wait, magnet.stop),
    Command(syringe.release_switch, syringe.wait, syringe.stop),
    Command(syringe.search_switch, syringe.wait, syringe.stop),
    Command(syringe.go_to_switch_latch_position, syringe.wait, syringe.stop),
    Command(syringe.search_encoder_n_signal, syringe.wait, syringe.stop),
    Command(syringe.go_to_encoder_n_signal, syringe.wait, syringe.stop),
    Command(syringe.set_home_position, syringe.wait, syringe.stop),
    Command(syringe.shift_from_home, syringe.wait, syringe.stop),
    Command(syringe.finish_home, syringe.wait, syringe.stop),
    Command(chamber.search_encoder_n_signal, chamber.wait, chamber.stop),
    Command(chamber.go_to_encoder_n_signal, chamber.wait, chamber.stop),
    Command(chamber.go_to_offset_position, chamber.wait, chamber.stop),
    Command(chamber.set_home_position, chamber.wait, chamber.stop),
    Command(chamber.shift_from_home, chamber.wait, chamber.stop),
    Command(chamber.finish_home, chamber.wait, chamber.stop),
